...
def motor_status():
    ...
    # ...
    wrk = motor_controller.is_working()
    sts = motor_controller.m_status()
    """Server view to get status of the motor (working or not working)."""
    # ...
    #print("Motor Status:" + str(wrk) + '/n')
    #print("Rotation status: " + str(sts) + '/n')

    return jsonify(motor_controller.m_status())
    return {'success': True}
